...
abstract contract ERC2981 is IERC2981 {
  ...
  function royaltyInfo(
    ...
    modifier creatorOnly(uint256 _tokenId) {
      require(
          royalty[_tokenId].receiver == msg.sender, 
...
contract GameItems is Initializable, ERC1155Upgradeable, OwnableUpgradeable, UUPSUpgradeable, ERC2981 {
    string public name;
    ...
    function setRoyaltyInfo(uint256 _tokenId, address _royaltyAddress, uint256 _percentage) public onlyOwner {
    _setRoyalties(_tokenId, _royaltyAddress, _percentage);
  }
